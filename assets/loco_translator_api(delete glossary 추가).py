...
def create_glossary(languages, project_id, glossary_name, glossary_uri, timeout=180):
...
##############################################################################
##############################################################################
#glossary 파일 교체 시 꼭 delete_glossary를 해주고 재생성해야함!~~!!
...
def delete_glossary(
    ...
    name = client.glossary_path("delta-coast-382412", "us-central1", glossary_id)
